...
| <a name="input_cert_manager_version"></a> [cert\_manager\_version](#input\_cert\_manager\_version) | Version of cert-manager to install alongside Rancher and Opni (format: 0.0.0) | `string` | `"1.10.0"` | no |
...
| <a name="input_opni_version"></a> [opni\_version](#input\_opni\_version) | Opni version | `string` | `"0.8.3"` | no |
...
| <a name="input_rancher_version"></a> [rancher\_version](#input\_rancher\_version) | Rancher version | `string` | `"2.7.1"` | no |
